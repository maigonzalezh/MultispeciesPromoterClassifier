...
# # RANDOM FIXED
# cd-hit-est -i ./data/processed/random-fixed/sample.fasta -o ./temp/random_fixed_samples_filtered.fasta -c 0.8 -n 5 -T 0 -M 0 && \
# cd-hit-est-2d -i ./temp/pmd_promoters_filtered.fasta -i2 ./temp/random_fixed_samples_filtered.fasta -o ./temp/random_fixed_cross_filtered.fasta -c 0.8 -n 5 -T 0 -M 0
...
# cp ./temp/random_fixed_cross_filtered.fasta ./data/processed/random-fixed/sample_cross_filtered.fasta
