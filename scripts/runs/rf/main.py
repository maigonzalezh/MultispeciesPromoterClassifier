...
def build_parser():
    parser = argparse.ArgumentParser(description="Train models for promoter prediction")
    ...
    parser.add_argument(
        "--non_promoter_origin", type=str, default="random", choices=["random", "cds"]
    )
...
def main():
    ...
    best_params = {
        "cds": {"m": "sqrt", "n_estimators": 3000},
        "random": {"m": "sqrt", "n_estimators": 5000},
    }
    ...
    training_args = {
        ...
        "param_space": {
            ...
            "n_estimators": tune.grid_search(
                [best_params[args.non_promoter_origin]["n_estimators"]]
            ),
        },
    }
